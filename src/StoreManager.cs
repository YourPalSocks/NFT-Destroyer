...
public class StoreManager : Control
{
    ...
    private int changePrice(int start, int min, int max)
    {
        // Change price by adding random value
        start += rng.RandiRange(min, max);
